      ...
      <div className="home">
        ...
        <section className="hero">
            ...
            <p className="subtitle">
                Roomify is an AI-first design
                environment that help you visualize, render, and ship
        ...
        <section className="projects">
            <div className="section-inner">
                <div className="section-head">
                    <div className="copy">
                        <h2>Projects</h2>
                        <p>View your latest projects and share community projects all in one place.</p>
                    </div>
                </div>
